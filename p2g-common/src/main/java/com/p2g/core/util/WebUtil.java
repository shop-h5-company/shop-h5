...
public final class WebUtil {
	...
	public static final void saveCurrentUser(Object user) {
		setSession(Resources.constants.getString(Constants.CURRENT_USER), user);
	}
	...
	public static final Object getCurrentUser() {
		...
		if (null != currentUser) {
			...
			if (null != session) {
				return session.getAttribute(Resources.constants.getString(Constants.CURRENT_USER));
			}
		}
		return null;
	}
	...
	public static final void removeCurrentUser(HttpServletRequest request) {
		request.getSession().removeAttribute(Resources.constants.getString(Constants.CURRENT_USER));
	}
