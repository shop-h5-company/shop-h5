...
import com.p2g.core.support.security.BASE64Encoder;
import com.p2g.core.support.security.coder.*;
...
public final class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(encryptMd5(encryptSHA("111111"+"2349079898")));
		System.out.println(encryptSHA("111111"+"2349079898"));
