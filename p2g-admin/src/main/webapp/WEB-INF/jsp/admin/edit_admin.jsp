        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="adminCode" id="adminCode" value="${admin.adminCode}" data-rule="管理员账号:required" size="20">
                </td>
                <td>
                    <label for="adminName" class="control-label x85">管理员姓名：</label>
                    <input type="text" name="adminName" id="adminName" value="${admin.adminName}" data-rule="管理员姓名:required" size="20">
                </td>
            </tr>
            <tr>
                <td colspan="2">
