...
<div class="bjui-pageContent">
    <form action="/taskGroup/addSubmit" class="pageForm" data-toggle="validate">
        <input type="hidden" name="dialog.id" value="edce142bc2ed4ec6b623aacaf602a4de">
        <table class="table table-condensed table-hover">
            <tbody>
            <tr>
                <td colspan="2" align="center"><h3>* 新增定时分组</h3></td>
            </tr>
            <tr>
                <td>
                    <label for="groupName" class="control-label x90">分组名称：</label>
                    <input type="text" name="groupName"  id="groupName" value="" data-rule="配置编码:required" size="20">
                </td>
                <td>
                    <label for="groupDesc" class="control-label x85">分组描述：</label>
                    <input type="text" name="groupDesc" id="groupDesc" value="" data-rule="配置内容:required" size="20">
                </td>
            </tr>
            <tr>
                <td colspan="2" >
