...
<div class="bjui-pageContent">
    <form id="lianBankForm" action="/lian/addLianBankSubmit" class="pageForm" data-toggle="validate">
        <input type="hidden" name="dialog.id" value="edce142bc2ed4ec6b623aacaf602a4de">
        <table class="table table-condensed table-hover">
            <tbody>
            <tr>
                <td colspan="2" align="center"><h3>* 新增支持银行</h3></td>
            </tr>
            <tr>
                <td>
                    <label for="lianBankCode" class="control-label x90">银行编码：</label>
                    <input type="text" name="lianBankCode"  id="lianBankCode" value="" data-rule="银行编码:required" size="20">
                </td>
                <td>
                    <label for="bankName" class="control-label x90">银行名称：</label>
                    <input type="text" name="bankName" id="bankName" value="" data-rule="银行名称:required" size="20">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="singleAmt"  id="singleAmt" value="" size="20">
                </td>
            </tr>
            <tr>
                <td>
                    <label for="dayAmt" class="control-label x90">单日限额：</label>
                    <input type="text" name="dayAmt" id="dayAmt" value="" size="20">
                </td>
                <td>
                    <label for="monthAmt" class="control-label x90">单月限额：</label>
                    <input type="text" name="monthAmt"  id="monthAmt" value=""  size="20">
                </td>
            </tr>
            <tr>
                <td>
           ...
           <tr>
                <td>
                    ...
                    <input type="text" name="bankLogo" id="bankLogo" value="" size="20">
                </td>
                <td>
                    <label for="seqNum" class="control-label x90">排列顺序：</label>
                    <input type="text" name="seqNum" id="seqNum" value="" size="20">
                </td>
            </tr>
            </tbody>
        </table>
