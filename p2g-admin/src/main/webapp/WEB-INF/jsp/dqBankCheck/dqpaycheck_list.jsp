...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="/dqBankCheck/getList" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <label for="checkStatus" >付款状态:</label>
        ...
        <c:forEach items="${pageInfo.list}" var="pageInfo" varStatus="status">
            <tr data-id="${status.index+1}">
                ...
                <td>
                    ...
                    <a href="/dqBankCheck/dqpaycheck?depositBankCheckId=${pageInfo.depositBankCheckId}" class="btn btn-green" data-toggle="dialog" data-id="dialog" data-height="400" data-width="800" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？"  data-title="审核-${pageInfo.transNo}">审核</a>
