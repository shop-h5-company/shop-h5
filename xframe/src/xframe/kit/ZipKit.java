...
public class ZipKit
{
     ...
     * @throws Exception
     */
    public static void zipDir(String dest, String dir) throws Exception
    {
        File directory = new File(dir);
        if (!directory.isDirectory()) throw new Exception("\"" + dir + "\" is not a directory!");
     ...
     * @throws Exception
     */
    public static void zipFile(String dest, String... src) throws Exception
    {
        File destination = new File(dest);
        OutputStream os = new FileOutputStream(destination);
        BufferedOutputStream bos = new BufferedOutputStream(os);
    ...
    {
//        ZipKit.zipFile("c:/z.zip","c:/ssl.conf", "c:/j.jpg");
//        ZipKit.zipDir("c:/z.zip","c:/id5");
        ZipKit.unzip("c:/z.zip", "c:/");
    }
